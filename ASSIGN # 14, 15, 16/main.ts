...
let guestlist: string[]=["Yasir","Raheel","Faraz"];
//for each
...
//  });
 ...
 let invited:string[]= guestlist.map(guest => ` Dear ${guest}, you are cordially invited to dinner`)
 console.log(invited);

//ASSIGN # 15.............................................../
 
let guestlist1: string[] = ["Yasir", "Raheel", "Faraz"];

//print the name who can,t come to dinner.?
let unableattend: string | undefined;
unableattend = <string>guestlist.splice(1, 1)[0];
